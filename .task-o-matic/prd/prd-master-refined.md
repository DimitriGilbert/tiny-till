...
*   **UI Components:** Shadcn UI (Radix UI primitives + Tailwind customization)
...
- [ ] Initialize Turborepo with single `apps/tiny-till` package
- [ ] Configure TanStack Router v1 with file-based routing
- [ ] Install Shadcn UI and configure Tailwind theme
...
*   **Integration Tests:**
    *   End-to-end tally workflow (add items → clear → verify reset)
    *   Catalog CRUD with IndexedDB persistence
    *   Import validation with corrupt/valid files
*   **Manual Testing:**
...
*   **Screen Reader Support:**
    ...
    *   Live region announcements for tally total updates
